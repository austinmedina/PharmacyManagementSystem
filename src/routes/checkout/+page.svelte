...
<main class="mx-20 lg:mx-40">
    ...
    <div class="flex flex-col gap-4 p-4 mb-4 max-h-80 border-2 border-neutral-500 overflow-auto">
        <Item />
        <Item />
        <Item />
        <Item />
    ...
    <div class="flex justify-center items-center">
        <button on:click={toggleCart} class="bg-orange-500 hover:bg-orange-400 py-2 px-6 text-white text-xl rounded-xl">Checkout Cart</button>
    </div>
    ...
    <div class="absolute top-0 left-0 w-full h-screen flex justify-center items-center">
        <div class="bg-blue-200 w-1/2 h-2/3 rounded-3xl p-4">
            ...
            <div class="flex flex-col gap-4 p-4 mb-8 mx-12 max-h-80 border-2 border-neutral-500 overflow-auto">
                <CartItem />
                <CartItem />
                <CartItem />
                <CartItem />
            ...
            <div class="flex justify-center gap-8">
                <button class="py-2 px-6 text-xl bg-green-500 hover:bg-green-400 rounded-xl">Purchase</button>
                <button class="py-2 px-6 text-xl bg-blue-500 hover:bg-blue-400 rounded-xl">Clear Cart</button>
            </div>
        </div>
    </div>
    {/if}
